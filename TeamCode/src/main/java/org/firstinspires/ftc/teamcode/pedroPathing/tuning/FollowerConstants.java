...
public class FollowerConstants {
    ...
    private static double xMovement = 79.20277368740773;
    private static double yMovement = 63.86870857298843;
    ...
    public static double mass = 9.752236;
    ...
    public static double forwardZeroPowerAcceleration = -46.46841786925754;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -77.95594609482777;
