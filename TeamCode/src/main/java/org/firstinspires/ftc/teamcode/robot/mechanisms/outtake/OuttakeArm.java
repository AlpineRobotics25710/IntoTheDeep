...
public class OuttakeArm extends SubsystemBase {
    ...
    public static double ARM_TRANSFER_POS = 0.2; // COMPLETE
    ...
    // Wrist positions
    public static double WRIST_WALL_INTAKE_FRONT_POS = 0.7; // Adjust as needed
    public static double WRIST_WALL_INTAKE_BACK_POS = 0.8; // Adjust as needed
    public static double WRIST_TRANSFER_POS = .5; // COMPLETE
