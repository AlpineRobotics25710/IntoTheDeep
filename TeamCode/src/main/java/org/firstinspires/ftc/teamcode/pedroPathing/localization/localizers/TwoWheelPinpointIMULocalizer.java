...
public class TwoWheelPinpointIMULocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.0019697292456123;
    public static double STRAFE_TICKS_TO_INCHES = 0.001964347125503735;
    ...
    public TwoWheelPinpointIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(127 / 25.4, -46.0375 / 25.4);
        strafeEncoderPose = new Pose(127 / 25.4,1.0 , Math.toRadians(90));
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "backLeftMotor"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "backRightMotor"));
