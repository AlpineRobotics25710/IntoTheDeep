...
public class DrivetrainBuilder {
     ...
     * @return The current DrivetrainBuilder instance for method chaining.
     */
    public DrivetrainBuilder setRevHubOrientations(
    ...
    public Drivetrain build() {
        ...
        if (imu == null && type == DrivetrainType.FIELD_CENTRIC_MECANUM) {
            throw new IllegalStateException("IMU must be set before building the drivetrain because " +
                    "you are using a field-centric drivetrain.");
        }
        if (gamepad == null) {
        ...
        switch (type) {
            case FIELD_CENTRIC_MECANUM:
                FieldCentricMecanumDrivetrain fieldCentric = new FieldCentricMecanumDrivetrain(
            ...
            case ROBOT_CENTRIC_MECANUM:
                RobotCentricMecanumDrivetrain robotCentric = new RobotCentricMecanumDrivetrain(
                        frontLeftMotor, backLeftMotor, frontRightMotor, backRightMotor,
                        gamepad
                );
